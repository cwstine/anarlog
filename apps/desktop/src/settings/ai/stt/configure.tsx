              ...
              : providerId === "openai"
                ...
                : providerId === "openrouter"
                  ...
                  : providerId === "dashscope"
                    ...
                    : providerId === "zai"
                      ? `Use [Z.AI GLM ASR](https://docs.z.ai/guides/audio/glm-asr-2512) for batch transcription. Corola automatically splits recordings to fit Z.AI's 30-second upload limit.`
                                    ...
                                    : providerId === "azure_speech"
                                      ...
                                      : providerId === "aws_transcribe"
                                        ...
                                        : providerId === "speechmatics"
                                          ...
                                          : providerId === "revai"
                                            ? `Use [Rev AI](https://docs.rev.ai/api/asynchronous/get-started) asynchronous transcription. Corola uploads the recording, waits for the job, and retrieves word timestamps and speaker labels.`
                                            : providerId === "custom"
