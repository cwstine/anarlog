...
const SKILL_DIR_NAME: &str = "minuteswise";

// The published skill package from `skills/minuteswise`, embedded at build time so
// installs work offline and always match the running app version.
const SKILL_FILES: &[(&str, &str)] = &[
    (
        "SKILL.md",
        include_str!("../../../../skills/minuteswise/SKILL.md"),
    ),
    (
        "references/cli.md",
    ...
    (
        ...
        include_str!("../../../../skills/minuteswise/references/errors.md"),
    ),
    (
        "references/mcp.md",
        include_str!("../../../../skills/minuteswise/references/mcp.md"),
    ),
    (
        "references/setup.md",
...
fn home_dir() -> Result<PathBuf, String> {
    dirs::home_dir().ok_or_else(|| "MinutesWise could not find your home directory.".to_string())
}
